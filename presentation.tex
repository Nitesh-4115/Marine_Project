...
% ─── Theme Configuration ─────────────────────────────────────────────────────
\usetheme{Madrid}
\usecolortheme[named=oceanblue]{structure}

\setbeamercolor{title}{fg=white,bg=oceanblue}
\setbeamercolor{subtitle}{fg=cyancol}
\setbeamercolor{frametitle}{fg=white,bg=oceanblue}
\setbeamercolor{frametitle right}{bg=midblue}
\setbeamercolor{block title}{fg=white,bg=midblue}
\setbeamercolor{block body}{fg=black,bg=surfaceblue}
...
\setbeamercolor{block body example}{fg=black,bg=green!8}
\setbeamercolor{alerted text}{fg=warnred}
\setbeamercolor{example text}{fg=okgreen}
\setbeamercolor{itemize item}{fg=midblue}
\setbeamercolor{itemize subitem}{fg=cyancol}
\setbeamerfont{frametitle}{size=\large,series=\bfseries}
\setbeamerfont{block title}{series=\bfseries}

\setbeamertemplate{navigation symbols}{}
\setbeamertemplate{itemize item}{\color{midblue}\textbullet}
\setbeamertemplate{itemize subitem}{\color{cyancol}$\triangleright$}

% Custom footline
\setbeamertemplate{footline}{
  \leavevmode
  \hbox{%
    \begin{beamercolorbox}[wd=.60\paperwidth,ht=2.4ex,dp=1.2ex,leftskip=4pt]{palette quaternary}
      \usebeamerfont{author in head/foot}
      \textcolor{white}{\textbf{Marine Robotics Course Project} \;|\; Nitesh, Dhruv, Suchit, Surya}
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.40\paperwidth,ht=2.4ex,dp=1.2ex,rightskip=4pt,right]{palette primary}
      \usebeamerfont{date in head/foot}
      \textcolor{white}{AUV Trajectory Tracking Control \quad \insertframenumber{}/\inserttotalframenumber}
    \end{beamercolorbox}%
  }%
}

% Remove headline clutter
\setbeamertemplate{headline}{}

% ─── Helper Commands ─────────────────────────────────────────────────────────
\newcommand{\highlight}[1]{\textcolor{cyancol}{\textbf{#1}}}
\newcommand{\redhl}[1]{\textcolor{warnred}{\textbf{#1}}}
\newcommand{\greenhl}[1]{\textcolor{okgreen}{\textbf{#1}}}
